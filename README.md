...
This repository implements a complete end-to-end machine learning pipeline, covering all stages of the ML lifecycle — from raw data ingestion to model evaluation — following industry and research best practices.
...
- Separate concerns across data ingestion, preprocessing, modeling, and evaluation
- Apply reproducible and deterministic ML workflows
...
5. **Evaluation**  
   Evaluates model performance using standardized metrics.
